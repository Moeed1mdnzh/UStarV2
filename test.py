...
G_state = torch.load("/content/UStarV2/generator_weights_4.pt")
D_state = torch.load("/content/UStarV2/discriminator_weights_4.pt")
G_model.load_state_dict(G_state["state_dict"])
G_opt.load_state_dict(G_state["optimizer"])
D_model.load_state_dict(D_state["state_dict"])
D_opt.load_state_dict(D_state["optimizer"])
